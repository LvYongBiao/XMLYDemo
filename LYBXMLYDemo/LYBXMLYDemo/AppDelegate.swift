...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func customIrregularityStyle(delegate: UITabBarControllerDelegate?) -> ESTabBarController {
        ...
        let v2 = FMHomeController()
        let v3 = FMHomeController()
        let v4 = FMHomeController()
        let v5 = FMHomeController()
        ...
        v3.tabBarItem = ESTabBarItem.init(YYIrregularityBasicContentView(), title: nil, image: UIImage(named: "tab_play"), selectedImage: UIImage(named: "tab_play"))
